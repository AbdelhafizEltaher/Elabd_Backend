...
const { AddNewProduct, UpdateProduct, GetAllProducts, GetProductById, DeletProducById ,GetProductsStats } = require('../Controlers/productControler')
...
router.get("/", async function (request, response, next) {
   try {
      ...
      let QCategory=request.query.QCategory
      let latestProducts=request.query.latestProducts
      let oldestProducts=request.query.oldestProducts
      let Products = await GetAllProducts(skip, limit ,name ,price ,latestProducts,oldestProducts ,QCategory)
